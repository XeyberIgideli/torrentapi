...
//         this.categories= {
//             "All": "",
//             "Movies": "url:/search/{query}/category/movies/",
//             "TV": "url:/search/{query}/category/tv/",
//             "Music": "url:/search/{query}/category/music/",
//             "Games": "url:/search/{query}/category/games/",
//             "Books": "url:/search/{query}/category/books/",
//             "Applications": "url:/search/{query}/category/applications/",
//             "Anime": "url:/search/{query}/category/anime/"
//          }
//         this.defaultCategory = "All"
//         this.baseUrl = "https://kickasstorrents.cr/"
//         this.searchUrl = "/search/{query}/"
//         this.size
...
//             let body 
//             for(let i = 1; i <= totalPage; i++) {
//                 body += await cloudScraper.get(this.getUrl(category,query, i) )
//             }   
//             let torrents = this.limitResults(this._parseTorrents(body,size, sortBy, sortOrder), limit)
